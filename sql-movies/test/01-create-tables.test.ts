...
const CREATE_ACTORS_TABLE = `create table ${ACTORS}{
  ...
  full_name NOT NULL primary key,
}`;

const CREATE_KEYWORDS_TABLE = `create table ${KEYWORDS}{
  id integer NOT NULL primary key,
  keyword NOT NULL primary key,
}`;
